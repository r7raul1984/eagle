...
public class UnitSparkTopologyRunner implements Serializable {
    ...
    private static final String SLIDE_DURATION = "topology.slideDurations";
    private static final String WINDOW_DURATIONS = "topology.windowDurations";
    ...
    private void buildTopology(JavaStreamingContext jssc, Config config) {
        ...
        int slideDurations = config.getInt(SLIDE_DURATION);
